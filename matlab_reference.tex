...
\verb!eps!  & 1\\
\verb!flops! & count of ßoating point operations \\
\verb!Inf!  & infinity\\
\verb!NaNa! & NaN\\
\verb!pi! & the math pi (3.1415É) \\
...
\verb!A(2,3)!    &  2Õnd row, 3Õrd column of matrix A\\
...
\verb!A(1,end)!    &  last element in 1Õst row\\
\end{tabular}
...
Based on the works of Winston Chang and Giordano Fusco\newline
